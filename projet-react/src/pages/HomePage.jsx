...
const HomePage = () => {
 ...
 const navigate = useNavigate();
  ...
  const goToPage = () => {
    navigate('/login');  // توجه مباشرة إلى صفحة login
  };
  const goToPagee = () => {
    navigate('/register');  // توجه مباشرة إلى صفحة login
  };
  return (
<>
  ...
  <div>
    <header className="sticky top-0 bg-white shadow">
      <div className="container flex flex-col sm:flex-row justify-between items-center mx-auto py-4 px-8">
        ...
        {/* <div className="p-8">
            <a href="/login" className="py-3 px-8 text-sm bg-teal-500 hover:bg-teal-600 rounded text-white inline-block">
                Se connecter
            </a>
        </div> */}
 <div 
  onClick={goToPage}  // عند الضغط على div كامل، يتم التوجيه
>
  Se connecter
</div>

<div
  onClick={goToPagee}  // عند الضغط على div كامل، يتم التوجيه
>
  S'inscrire
</div>
